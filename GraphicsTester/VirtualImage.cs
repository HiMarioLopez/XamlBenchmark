...
namespace GraphicsTester
{
    public class VirtualImage : IImage
    {
        ...
        {
#if DEBUG
            Debug.WriteLine("Downsizing not supported in virtual image.");
#endif
            return this;
        }
        ...
        {
#if DEBUG
            Debug.WriteLine("Resizing not supported in virtual image.");
#endif
            return this;
        }
        ...
        {
            throw new Exception("Converting from an unspecified Image implementation is not possible.");
        }
    }
}